...
# Automatic mode
for name in names:
    print(f"Hi, i'm {name}, nice to meet you!")
#In my mind, it seemed like a good idea (import random)
...
for car in cars:
    print(emoji.emojize(f'I would like to own a {car}:smiling_face_with_sunglasses:'))
print('\n')
...
print(f'''
Dear {removedGuest_1}, For personal reasons, dinner has been canceled. 
Sorry for the inconvenience\n''')
print(f'''
Dear {removedGuest_2}, For personal reasons, dinner has been canceled. 
Sorry for the inconvenience\n''')
print(f'''
Dear {removedGuest_3}, For personal reasons, dinner has been canceled. 
Sorry for the inconvenience\n''')
print(f'''
Dear {removedGuest_4}, For personal reasons, dinner has been canceled. 
Sorry for the inconvenience\n''')
...
print(f'and in the end, only two people showed up for dinner {len(guests_List)}') #3.9

del guests_List[0]
del guests_List[0]
print(guests_List)

print(3*'---', 'Answer 3.8', 3*'---')
...
countryDreams.sort() # Permanent Random Order
print(f'\tPermanent Random Order: {countryDreams}')
countryDreams.sort(reverse=True)
print(f'\tNew Permanent Random Order: {countryDreams}')
